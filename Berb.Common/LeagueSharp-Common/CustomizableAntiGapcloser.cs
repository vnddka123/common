...
namespace LeagueSharp.Common
{
    ...
    public static class CustomizableAntiGapcloser
    {
        ...
        public static void AddToMenu(Menu mainmenu)
        {
            ...
            {
                mainmenu.Add("gapclose." + gapclose.ChampionName, new CheckBox("Anti-Gapclose: " + gapclose.ChampionName + " - Spell: " + gapclose.Slot));
                mainmenu.Add("gapclose.slider." + gapclose.SpellName, new Slider("" + gapclose.ChampionName + " " + "(" + gapclose.Slot + ") Priority", gapclose.DangerLevel, 1, 5));
            }
        }
                        ...
                        .Where(
                            cGapcloser =>
                                ...
                                (cGapcloser.SkillType == CGapcloserTypes.Skillshot &&
                                 ...
                                 && CustomizableCustomizableAntiGapcloserMenu["gapclose." + cGapcloser.Sender.ChampionName].Cast<CheckBox>().CurrentValue)
                                 .OrderByDescending(c => CustomizableCustomizableAntiGapcloserMenu["gapclose.slider." + c.SpellName].Cast <Slider>().CurrentValue))
            {
